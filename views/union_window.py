...
"color: rgb(80, 30, 83)")
        ...
        self.LESeleccionarCarpeta.setMinimumSize(QSize(300, 0))
        self.LESeleccionarCarpeta.setStyleSheet(u"background-color: rgb(229, 229, 229)")

        self.formLayout.setWidget(0, QFormLayout.LabelRole, self.LESeleccionarCarpeta)

        self.BTNSeleccionar = QPushButton(self.frame)
        self.BTNSeleccionar.setObjectName(u"BTNSeleccionar")
        self.BTNSeleccionar.setStyleSheet(u"background-color: rgb(80, 27, 85);\n"
"color: rgb(251, 186, 0);")

        self.formLayout.setWidget(0, QFormLayout.FieldRole, self.BTNSeleccionar)
